...
router.route('/update-profile').post(authenticateJWT, controller.updateProfile);
...
router.route('/exams').get(controller.getAllExam);//get all exam name and their logo
router.route('/exams/:id').get(controller.getExamById);
router.route('/createExams').post(controller.createExam);
router.route('/updateExams/:id').put(controller.updateExams);
router.route('/deletedExams/:id').delete(controller.deleteExam);
